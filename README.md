...
Система Study Plan осущетвляет формирование, хранение, редактирование учебных планов для университета.
...
соответствующих API. API для с системой Study Plan представлены в таблице.
